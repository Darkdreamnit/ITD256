...
#
# Script WKSH_20_09.SH is for educational use ONLY
...
# break database
cd $LABS
sqlplus / as sysdba @rm_redo_log_current.sql > /tmp/break.log
...
chmod 777 rm_fs_log_file.sh
$LABS/rm_fs_log_file.sh >> /tmp/break.log

# remove asm file for USERS tablespace
# Edited by DKK for non-ASM database January 2015
# chmod 777 rm_asm_users.sh
